...
function initTabSpecificMessaging() {
    ...
    if (currentTabID) {
        tabPort = browser.runtime.connect({ name: "NetPolish-Devtools-Tabs" });
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    browser.storage.local.get('devPanelSettings', function(result) {
...
browser.runtime.connect({name: "devtools-page"}).postMessage({action: "init"});
...
function addLogEntry(logData) {
    browser.storage.local.get('devPanelSettings', function(settings) {
